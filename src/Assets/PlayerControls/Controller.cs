...
public class Controller : MonoBehaviour
{
	...
	private void Update()
	{
		...
		// If the cursor is unlocked...
		if (Cursor.lockState == CursorLockMode.None)
		{
			//And the mouse is pressed, locks the cursor and resumes the time
		...
		// Otherwise, if the cursor is locked...
		else
        {
			// And the "p" key is pressed, unlocks the cursor and pauses the time
